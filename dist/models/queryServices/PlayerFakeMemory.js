...
//Fake用のクラス
var PlayerFakeMemory = /** @class */ (function () {
    function PlayerFakeMemory(source) {
        if (source == null) {
    ...
    PlayerFakeMemory.prototype.getDataBy = function () {
    ...
    return PlayerFakeMemory;
}());
exports.PlayerFakeMemory = PlayerFakeMemory;
//# sourceMappingURL=PlayerFakeMemory.js.map